...
global  Mu_max  Dq Ds Sigma Kg_WL Kg_WR Kg_Q LSc Sc t0 % global parameters, most of them are dimensionless
...
global QS_0 WL_0 WR_0 Alpha_1 Alpha_2 Alpha_3 Alpha_4 max_rate_WL Q_bar Q_BC g_l g_r
...
Nx = 8000;  % number of subtervals in the mesh

dx = 1.0/Nx; % spatial grid size

dt = 0.002;   % temporal grid size

FT = 48; % final time of the simulation, it's 24 hours since t0 = 1 hour
