...
% equation for p (product), the matrix is tridiagonal with size Nx
...
%  impose the Dirichlet BC at x = 1 (j = n), lacetate concentration is zero
rhs(n) = rhs(n) - f1(n)*0;
